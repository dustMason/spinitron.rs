...
<header class="site-header"><a class="wordmark" href="{base}index.html"><span aria-hidden="true">▥</span> SPINITRON</a><nav aria-label="Catalog views"><a href="{base}index.html"{' aria-current="page"' if recent else ''}>Recent imports</a><a href="{base}archive/index.html"{' aria-current="page"' if not recent else ''}>All playlists <span>{len(rows):,}</span></a></nav></header>
<div class="intro-line"><span>Updated {config['updatedLabel']}</span></div>
